                    ...
                    <li className="text-yellow-50 text-sm md:text-base hover:text-yellow-500 hover:underline"><Link href="/favorites"><Heart /></Link></li>
                        ...
                        {user ? (
                            <div className="flex items-center gap-2">
                                <li className="text-yellow-50 font-semibold text-sm md:text-base bg-yellow-500 rounded-full py-1 px-3 cursor-pointer flex items-center justify-center gap-2">
                                    <Link href="/login"><User2 strokeWidth={3}/></Link>
                                    <span>
